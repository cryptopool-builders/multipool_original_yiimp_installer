...
# 
# Updated:  cryptopool.builders
#
# Program:
#   Install yiimp on Ubuntu 16.04 running Nginx, MariaDB, and php7.x
# BTC Donation: 3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx
# 
################################################################################
output() {
    printf "\E[0;33;40m"
...
output ""
    ...
    clear 
    output "If you found this helpful, please donate to BTC Donation: 3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx"
    output ""
...
' | sudo -E tee /etc/yiimp/keys.php >/dev/null 2>&1
    ...
    output ""
    output "BTC Donation: 3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx"
    output ""
...
define('"'"'YAAMP_BTCADDRESS'"'"', '"'"'3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx'"'"');
...
$cold_wallet_table = array(
	'"'"'3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx'"'"' => 0.10,
);
...
output ""
output "If you found this script helpful please consider donating some BTC Donation: 3KVsaohUu58xcX1dvLUqJVNmaxQt5n1Tnx"
